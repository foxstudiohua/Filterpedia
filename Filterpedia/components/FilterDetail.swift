...
class FilterDetail: UIView
{
    ...
    func applyFilter()
    {
        ...
        let queue:DispatchQueue = currentFilter is VImageFilter ?
            .main : .global()
        ...
        queue.async
        {
            ...
            DispatchQueue.main.async
            {
                ...
                if let fCGImage = finalImage {
                    self.imageView.image = UIImage(cgImage: fCGImage)
                }
    ...
    override func layoutSubviews()
    {
        ...
        let twoThirdHeight = min(self.width, self.height * 0.666)
        let thirdHeight = twoThirdHeight * 0.5
        ...
        tableView.frame = CGRect(x: 0,
            y: twoThirdHeight,
            width: frame.width,
            height: self.height-twoThirdHeight)
